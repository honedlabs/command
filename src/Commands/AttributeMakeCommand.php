...
class AttributeMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Create a new attribute class.';
    ...
    {
        return $this->resolveStubPath('/stubs/honed.attribute.stub');
    }
    ...
    {
        return [
            ['force', null, InputOption::VALUE_NONE, 'Create the class even if the attribute already exists'],
        ];
    }

    /**
     * Attribute for missing input arguments using the returned questions.
     *
